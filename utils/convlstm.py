...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input, internal_state=[]):
        ...
        :param input: (bsize, channel , height, width)
        :param initial_state: initial state of the game state, can be used to remember cell state.
        :return: outputs, (the last output, the)
        """
        ...
        for i in range(self.num_layers):
            ...
            x, new_c = getattr(self, name)(x, h, c)     # return (hidden state, cell state)
